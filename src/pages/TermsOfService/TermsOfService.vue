<template>
    <div class="bg-gradient-to-b from-blue-100 to-white min-h-screen font-sans">
        ...
        <div class="container mx-auto mt-10 px-8">
            ...
            <h3 class="text-2xl font-medium mb-5">第1条（適用）</h3>
            <p class="mb-10">
            ...
            <h3 class="text-2xl font-medium mb-5">第2条（利用登録）</h3>
            <p class="mb-10">
                本サービスにおいては，登録希望者が本規約に同意の上，運営者の定める方法によって利用登録を申請し，運営者がこれを承認することによって，利用登録が完了するものとします。
                運営者は，利用登録の申請者に以下の事由があると判断した場合，利用登録の申請を承認しないことがあり，その理由については一切の開示義務を負わないものとします。<br />
                ・利用登録の申請に際して虚偽の事項を届け出た場合<br />
                ・本規約に違反したことがある者からの申請である場合<br />
                ・その他，運営者が利用登録を相当でないと判断した場合<br />
            </p>
            ...
            <h3 class="text-2xl font-medium mb-5">第4条（禁止事項）</h3>
            <p class="mb-10">
                ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。<br />
                ・法令または公序良俗に違反する行為 犯罪行為に関連する行為。<br />
                ・本サービスの内容等，本サービスに含まれる著作権，商標権ほか知的財産権を侵害する行為。<br />
                ・運営者，ほかのユーザー，またはその他第三者のサーバーまたはネットワークの機能を破壊したり，妨害したりする行為。<br />
                ・本サービスによって得られた情報を商業的に利用する行為。<br />
                ・運営者のサービスの運営を妨害するおそれのある行為。<br />
                ・不正アクセスをし，またはこれを試みる行為。<br />
                ・他のユーザーに関する個人情報等を収集または蓄積する行為。<br />
                ・不正な目的を持って本サービスを利用する行為。<br />
                ・本サービスの他のユーザーまたはその他の第三者に不利益，損害，不快感を与える行為。<br />
                ・他のユーザーに成りすます行為。<br />
                ・運営者が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為。<br />
                ・運営者のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為。<br />
            ...
            <p class="mb-10">
                ...
                運営者は，本サービスの提供の停止または中断により，ユーザーまたは第三者が被ったいかなる不利益または損害についても，一切の責任を負わないものとします。<br />
            </p>
            ...
            <p class="mb-10">
                運営者は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。<br />
                ・本規約のいずれかの条項に違反した場合<br />
                ・登録事項に虚偽の事実があることが判明した場合<br />
                ・料金等の支払債務の不履行があった場合<br />
                ・運営者からの連絡に対し，一定期間返答がない場合<br />
                ・本サービスについて，最終の利用から一定期間利用がない場合<br />
                ・その他，運営者が本サービスの利用を適当でないと判断した場合<br />
            ...
            <h3 class="text-2xl font-medium mb-5">第9条（利用規約の変更）</h3>
            <p class="mb-10">
            ...
            <h3 class="text-2xl font-medium mb-5">第11条（通知または連絡）</h3>
            <p class="mb-10">
